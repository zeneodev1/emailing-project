...
public class SuppressionManager implements Controller {
    ...
    public void start(final String[] parameters) throws Exception {
        ...
        try {
            ...
            SuppressionManager.MD5_EMAILS = Collections.unmodifiableSet(new HashSet<String>(md5lines));
            System.out.println(md5lines.size());
            DataList dl = new DataList();
            dl.name = "emails.fresh_emails";
            dl.id = 10;
            final List<DataList> dataLists = Arrays.asList(dl);
